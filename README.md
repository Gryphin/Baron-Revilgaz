<h1 align="center">
  <br>
  <a href="https://github.com/Cog-Creators/Red-DiscordBot/tree/V3/develop"><img src="https://wow.zamimg.com/uploads/screenshots/normal/28422-baron-revilgaz-old-model.jpg" alt="Baron Revilgaz - Discord Bot"></a>
  <br>
  Baron Revilgaz Bot
  <br>
</h1>
...
<p align="center">
  ...
  <a href="https://crowdin.com/project/Baron Revilgaz-discordbot">
    <img src="https://d322cqt584bo4o.cloudfront.net/Baron Revilgaz-discordbot/localized.svg" alt="Localized with Crowdin">
  </a>
</p>
...
<p align="center">
  ...
  •
  <a href="http://docs.discord.Baron Revilgaz/en/stable/index.html">Documentation</a>
  •
...
Baron Revilgaz is a fully modular bot – meaning all features and commands can be enabled/disabled to your
liking, making it completely customizable. This is a *self-hosted bot* – meaning you will need
to host and maintain your own instance. You can turn Baron Revilgaz into an admin bot, music bot, trivia bot,
...
Baron Revilgaz is fully modular, allowing you to load and unload plugins of your choice, and install 3rd party
plugins directly from Discord! A few examples are:

- Cleverbot integration (talk to Baron Revilgaz and he talks back)
- Ban sync
- Welcome messages
- Casino
- Reaction roles
...
**Baron Revilgaz** is in continuous development, and it’s supported by an active community which produces new
